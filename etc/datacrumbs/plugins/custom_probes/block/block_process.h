...
#define GET_DATA_5_EXISTS

#if defined(DATACRUMBS_MODE) && (DATACRUMBS_MODE == 1)
datacrumbs::EventWithId* get_data_5(void* data, uint64_t index) {
  struct block_event_t* base = (struct block_event_t*)data;
...
#else
datacrumbs::EventWithId* get_data_5(void* data, uint64_t index) { return nullptr; }
#endif
